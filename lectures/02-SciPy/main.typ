...
#align(center + horizon)[
  #figure(
    image("figures/ndarray.png", width: 92%, height: 78%, fit: "contain"),
    caption: [思考一下我们地理信息领域有哪些数据可以表示为多维数组？],
    numbering: none,
  )
]
...
#align(center + horizon)[
  #figure(
    image("figures/array_dim.png", width: 92%, height: 78%, fit: "contain"),
    caption: [维度理解对于掌握数组索引、切片、合并等操作至关重要],
    numbering: none,
  )
]
...
#align(center + horizon)[
  #grid(
    ...
    align: horizon,
    figure(
      image("figures/anatomy.pdf", width: 100%, height: 78%, fit: "contain"),
      caption: [一个 Figure 中包含的所有可视化元素],
      numbering: none,
    ),
    figure(
      image("figures/subplots.png", width: 100%, height: 78%, fit: "contain"),
      caption: [多个子图构成一个Figure],
      numbering: none,
    ),
  )
]
